...
var sign = 0;
var messages = ["The dynamic that's responsible for all the hard work you've done lately is still very much in focus. " +
"There's a chance that a golden opportunity could come your way that adds to your workload but is too good to miss." +
" While you're quite the canny operator and not easily fooled, be sure from midweek that everything's in order by " +
"checking the details and fine print. Lovely Venus in Libra suggests you'll be eager to make concessions even if it " +
"means compromising a little.","It may come as no surprise that one association is red hot right now, particularly" +
" early in the week, when a Scorpio connection hints at fire between the sheets. You'll also find you learn a lot from " +
"others, especially when it comes to monitoring your reactions to key situations. The people around you can teach you " +
"much about what's important to you and where you might need to change your attitude. Luscious Venus in Libra hints at" +
" the potential for lucrative deals." , "There's a lot going on in one of the more mysterious areas of your chart," +
" where the current lineup could enhance intimacy and perhaps encourage you to explore unusual and exciting ways to " +
"please your sweetheart. Being open and vulnerable could be very good for you. It's also an opportunity to let go of " +
"buried resentment and so experience feelings of lightness and peace. Career matters also get a boost, but you'll need" +
" to be cautious around money matters this week." , "This week's focus is very much geared toward productivity and " +
"plain old hard work. The difference is that you seem quite passionate about your involvement and eager to see results." +
" A romance could unexpectedly spring up with someone who shares your enjoyment of a certain subject or craft." +
" You might need to make a radical decision that brings about a positive change in your life. Lovely Venus in your " +
"health zone could motivate you to exercise more to be as fit as possible." , " The week ahead could make a few demands" +
" on you even though you're already eager to make progress. Thoughts of the approaching holiday season could coincide" +
" with a decision to get organized and perhaps make your gifts. At work, the current situation might need revamping, " +
"especially if old methods no longer cut the mustard. A few changes could transform things for the better. Finally, " +
"romance looks very promising, whether you're spoken for or newly in love." , "Your desire to have fun could snowball," +
...
"opportunity if you don't hurry. However, if you're excited about the many possibilities open to you, as the current " +
...
" you're tired and wired, you should cut back on activities so you can relax and recharge. You might also find it" +
" both nurturing and healing to pay attention to your creative muse. If you want to learn a new craft or musical " +
...
"look a little deeper into the situations and circumstances around you. Indeed, over the week ahead you may be" +
...
"Saturn in your spiritual sector, this is a chance to clear out any baggage you've accumulated in recent years." +
" We're talking about a deep clean rather than a superficial dust and vacuum. While you've likely been at this on and " +
"off over the past couple years, there's no time like the present to continue. It's the perfect time to make amends, " +
"clear away emotional clutter, and enhance vitality. Convivial Venus in Libra suggests one or two career deals could " +
"be moneymakers."];
...
function getZodiacAnimal(y){
    if(y == 2008 || y == 1996 || y == 1984 || y == 1972 || y == 1960){
        zodiac = ["You're Chinese Zodiac animal is a Rat!" , "<img src='zodiac/rat.png' />"];
    }
    if(y == 2009 || y == 1997 || y == 1985 || y == 1973 || y == 1961){
        zodiac =  ["You're Chinese Zodiac animal is an Ox!" , "<img src='zodiac/ox.jpeg' />"];
    }
    if(y == 2010 || y == 1998 || y == 1986 || y == 1974 || y == 1962){
        zodiac = ["You're Chinese Zodiac animal is a Tiger!" , "<img src='zodiac/tiger.jpg' />"];
    }
    if(y == 2011 || y == 1999 || y == 1987 || y == 1975 || y == 1963){
        zodiac = ["You're Chinese Zodiac animal is a Rabbit!" , "<img src='zodiac/Rabbit.gif' />"];
    }
    if(y == 2012 || y == 2000 || y == 1988 || y == 1976 || y == 1964){
        zodiac = ["You're Chinese Zodiac animal is a Dragon!" , "<img src='zodiac/dragon.jpg' />"];
    }
    if(y == 2013 || y == 2001 || y == 1989 || y == 1977 || y == 1965){
        zodiac = ["You're Chinese Zodiac animal is a Snake!" , "<img src='zodiac/snake.jpeg' />"];
    }
    if(y == 2014 || y == 2002 || y == 1990 || y == 1978 || y == 1966){
        zodiac = ["You're Chinese Zodiac animal is a Horse!" , "<img src='zodiac/horse.png' />"];
    }
    if(y == 2015 || y == 2003 || y == 1991 || y == 1979 || y == 1967){
        zodiac = ["You're Chinese Zodiac animal is a Goat!" , "<img src='zodiac/goat.jpeg' />"];
    }
    if(y == 2016 || y == 2004 || y == 1992 || y == 1980 || y == 1968){
        zodiac = ["You're Chinese Zodiac animal is a Monkey!" , "<img src='zodiac/monkey.jpeg' />"];
    }
    if(y == 2017 || y == 2005 || y == 1993 || y == 1981 || y == 1969){
        zodiac = ["You're Chinese Zodiac animal is a Rooster!" , "<img src='zodiac/rooster.jpeg' />"];
    }
    if(y == 2018 || y == 2006 || y == 1994 || y == 1982 || y == 1970){
        zodiac = ["You're Chinese Zodiac animal is a Dog!" , "<img src='zodiac/dog.jpeg' />"];
    }
    if(y == 2019 || y == 2007 || y == 1995 || y == 1983 || y == 1971){
        zodiac = ["You're Chinese Zodiac animal is a Pig!" , "<img src='zodiac/pig.jpg' />"];
    }
    return zodiac;
}
